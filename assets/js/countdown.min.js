...
b.push(h(c,0));return b};d.MILLISECONDS=1;d.SECONDS=2;d.MINUTES=4;d.HOURS=8;d.DAYS=16;d.WEEKS=32;d.MONTHS=64;d.YEARS=128;d.DECADES=256;d.CENTURIES=512;d.MILLENNIA=1024;d.DEFAULTS=222;d.ALL=2047;d.setLabels=function(a,b,c,d){a=a||[];a.split&&(a=a.split("|"));b=b||[];b.split&&(b=b.split("|"));for(var f=0;10>=f;f++)r[f]=a[f]||r[f],t[f]=b[f]||t[f];p="string"===typeof c?c:p;q="string"===typeof d?d:q};(d.resetLabels=function(){r="milisegundo segundo minuto hora dia semana mês ano década século milênio".split(" ");
t="milisegundo segundos minutos horas dias semanas meses anos décadas séculos milênios".split(" ");p="e ";q=", "})();u&&u.exports?u.exports=d:"function"===typeof window.define&&"undefined"!==typeof window.define.amd&&window.define("countdown",[],function(){return d});return d}(module);