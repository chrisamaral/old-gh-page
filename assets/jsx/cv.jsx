LazyLoad.js([
  ...
  var mount = {
    map: function () {
      ...
      var gInfo = new google.maps.InfoWindow({
        content: React.renderToStaticMarkup(
          <address style={{color: 'rgb(30, 30, 30)'}}>
            Rua Itapiru, 1459<br/>
            Rio Comprido - 20251-032<br/>
    ...
    birthday: function () {
      var FancyAge = React.createClass({
        ...
        render: function () {
          ...
          return (
            <span>{countdown(this.props.date, null, units).toString().replace(', e', ' e')}</span>
          );
        }
      });
    ...
    carousel: function () {
      LazyLoad.js(['/assets/js/cv.eng.carousel.js'], function () {
        React.render(<CVVideoCarousel />, document.getElementById('EngCarousel'));
      });
    }
  };
